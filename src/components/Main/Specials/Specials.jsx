...
const foodItems = [
    ...
    },
    {
        name: "New Recipie",
        price: "$8.00",
        description: "Steeped in tradition and bursting with authenticity, our new recipe is a treasured gem lifted from the worn pages of grandma's recipe book.",
        image : images.greekSalad,
    },
    ...
    return (
        ...
        >
           <div className="app__specials-title-and-btn">
             <h1 className="app__specials-title">Specialities</h1>
